...
func main() {
	...
	t.Insert("text:nine")
	t.Insert("text:ten")
	t.Insert("text:eleven")
	t.Insert("text:twelve")

	dump1(t)

	mx := &TreeNode{val: "text:root"}

	mx.Insert("text:one")
	mx.Insert("text:two")
	mx.Insert("text:three")
	mx.Insert("text:four")
	mx.Insert("text:five")
	mx.Insert("text:six")
	mx.Insert("text:seven")
	mx.Insert("text:eight")
	mx.Insert("text:nine")
	mx.Insert("text:ten")
	mx.Insert("text:eleven")
	mx.Insert("text:twelve")
	dump1(mx)
